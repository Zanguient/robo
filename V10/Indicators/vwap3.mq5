...
#property indicator_label8  "VWAP Level 06"
#property indicator_type8   DRAW_LINE
#property indicator_color8  clrBeige
#property indicator_style8  STYLE_DASH
#property indicator_width8  2
//+------------------------------------------------------------------+
//|                                                                  |
...
datetime CreateDateTime(DATE_TYPE nReturnType=DAILY,datetime dtDay=D'2000.01.01 00:00:00',int pHour=0,int pMinute=0,int pSecond=0) 
  ...
  string              Indicator_Name="Volume Weighted Average Price (VWAP)";
   ...
   input bool                Enable_Level_01         = true;
   input bool                Enable_Level_02         = true;
   input bool                Enable_Level_03         = true;
   input bool                Enable_Level_04         = true;
   input bool                Enable_Level_05         = true;   
   input bool                Enable_Level_06         = true;
   input double deslocamento  = 395;
...
int OnInit() 
  {
   ...
   SetIndexBuffer(1,VWAP_Buffer_01,INDICATOR_DATA);
   SetIndexBuffer(3,VWAP_Buffer_02,INDICATOR_DATA);
   SetIndexBuffer(4,VWAP_Buffer_03,INDICATOR_DATA);
   SetIndexBuffer(5,VWAP_Buffer_04,INDICATOR_DATA);
   SetIndexBuffer(6,VWAP_Buffer_05,INDICATOR_DATA);
   SetIndexBuffer(6,VWAP_Buffer_06,INDICATOR_DATA);
   ...
   ObjectSetInteger(0,"VWAP_Level_01",OBJPROP_YDISTANCE,60);
   ...
   ObjectSetInteger(0,"VWAP_Level_02",OBJPROP_YDISTANCE,80);
   ...
   ObjectSetInteger(0,"VWAP_Level_03",OBJPROP_YDISTANCE,100);
   ...
   ObjectSetInteger(0,"VWAP_Level_04",OBJPROP_YDISTANCE,120);
   ...
   ObjectSetInteger(0,"VWAP_Level_05",OBJPROP_YDISTANCE,140);
   ...
   ObjectCreate(0,"VWAP_Level_06",OBJ_LABEL,0,0,0);
   ObjectSetInteger(0,"VWAP_Level_06",OBJPROP_CORNER,3);
   ObjectSetInteger(0,"VWAP_Level_06",OBJPROP_XDISTANCE,180);
   ObjectSetInteger(0,"VWAP_Level_06",OBJPROP_YDISTANCE,160);
   ObjectSetInteger(0,"VWAP_Level_06",OBJPROP_COLOR,indicator_color8);
   ObjectSetInteger(0,"VWAP_Level_06",OBJPROP_FONTSIZE,7);
   ObjectSetString(0,"VWAP_Level_06",OBJPROP_FONT,"Verdana");
   ObjectSetString(0,"VWAP_Level_06",OBJPROP_TEXT," ");
         ...
         if(Enable_Daily && (nIdx>=nIdxDaily)) 
           {
            ...
            if(nSumDailyVol)
               ...
               //VWAP_Buffer_01[nIdx]=(nSumDailyTPV/nSumDailyVol - (3*deslocamento));
               VWAP_Buffer_02[nIdx]=(nSumDailyTPV/nSumDailyVol  - (3*deslocamento));
               VWAP_Buffer_03[nIdx]=(nSumDailyTPV/nSumDailyVol - (2*deslocamento));
               VWAP_Buffer_04[nIdx]=(nSumDailyTPV/nSumDailyVol - (1*deslocamento));
               //VWAP_Buffer_05[nIdx]=(nSumDailyTPV/nSumDailyVol + (2*deslocamento));
               //VWAP_Buffer_06[nIdx]=(nSumDailyTPV/nSumDailyVol + (3*deslocamento));
