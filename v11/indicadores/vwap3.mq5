...
datetime CreateDateTime(DATE_TYPE nReturnType=DAILY,datetime dtDay=D'2000.01.01 00:00:00',int pHour=0,int pMinute=0,int pSecond=0) 
  ...
  string              Indicator_Name="Volume Weighted Average Price (VWAP)";
   PRICE_TYPE          Price_Type              = CLOSE_HIGH_LOW;
    ...
    bool                Enable_Level_01         = true;
    bool                Enable_Level_02         = true;
    bool                Enable_Level_03         = true;
    bool                Enable_Level_04         = true;
    bool                Enable_Level_05         = true;   
    bool                Enable_Level_06         = true;
